...
print("Starts with D:")
a = [human.name for human in humans if human.name[0].lower() == check.lower()]
print(a)
...
print("Ends with e:")
b = [human.name for human in humans if human.name[-1].lower() == check.lower()]
print(b)
...
c = [human.name for human in humans if human.name.startswith(check)]
print(c)
